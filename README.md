...
[--> Next Demo 3 - Demo 3 - Securing your Egress Traffic within your apps with Egress IPs using GitOps <--](https://github.com/RedHat-EMEA-SSA-Team/ns-gitops/tree/egressip)
